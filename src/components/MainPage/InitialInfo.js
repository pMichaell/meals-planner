        ...
        <div className={classes.container}>
            <div>
                <div><img src={plan} className={classes.icon} alt="plan icon"/>
                    <h3 className={classes.header}>Create a meals plan neatly fitting your requirements in 3 easy steps!</h3>
                </div>
                ...
                <div><img src={bowl} className={classes.icon} alt="bowl icon"/>
                    <h3 className={classes.header}>Pick meals chosen exactly for your ingredient preferences!</h3>
                </div>
